...
<body>
	...
	<div id="mainContainer">
		<!-- 从session中获取学生集合 -->
		<strong>修改资源信息</strong>
		<hr>
		<form name="modifyForm" action="<%=path%>/UpLoad.action?types=resources&operation=save"
			method="post" enctype="multipart/form-data">
			<table width="750px">
				<tr>
					<td width="12%">资源编号：</td>
					<td><input type="text" name="id" readonly="readonly"
						value='<s:property value="#attr.modify_resources.id"/>' /></td>
				</tr>
				<tr>
					<td width="12%">资源标题：</td>
					<td><input type="text" name="title"
						value='<s:property value="#attr.modify_resources.title"/>' /></td>
				</tr>
				<tr>
					<td width="12%">资源类别：</td>
					<td><SELECT NAME="type" size=1>
							<c:forEach items="${Type_list}" var="tl">
								<c:if test="${tl.tid==modify_resources.tp.tid}">
				...
				<tr>
					...
					<td><input name="datetime" type="text"
						value="<s:date name="#attr.modify_resources.datetime" format="yyyy-MM-dd"/>" /></td>
				</tr>
				<tr>
					<td>上传资源：</td>
