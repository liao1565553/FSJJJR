...
<div id="wrapper">
		...
		<div id="mainBg">
			<div id="mainPanel">
				...
				<div id="right">
					...
					<form name="loginForm" action="<%=path%>/admin/Login_loginAdmin.action"  method="post">
					<!-- start of login form -->
					<div id="welcome">
					...
					<div id="user-name">
						...
						<span><input type="text" name="phone" class="form-input"></span>
					</div>
	...
	<div id="footer">
		<div id="text">Copyright © 2015-2019 All Rights Reserved Powered By Fashion</div>
	</div>
</div>
</body>
</html>