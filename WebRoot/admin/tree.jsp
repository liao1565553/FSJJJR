...
var treeMenu = [
	{ level:1, name:"基本信息"},
	{ level:2, name:"个人资料", ico:"images/icon_default.gif",link:"<%=path%>/admin/Users/detail.jsp"},
	
	{ level:1, name:"成员管理"},
	{ level:2, name:"成员列表", ico:"images/icon_default.gif",link:"<%=path%>/admin/Users_query.action"},
	{ level:2, name:"成员添加", ico:"images/icon_default.gif",link:"<%=path%>/admin/Users/addUsers.jsp"},
	
	{ level:1, name:"部门管理"},
	{ level:2, name:"部门列表", ico:"images/icon_default.gif",link:"<%=path%>/admin/Department_query.action"},
	{ level:2, name:"部门添加", ico:"images/icon_default.gif",link:"<%=path%>/admin/Department_add.action"},
	
	{ level:1, name:"客户管理"},
	{ level:2, name:"客户列表", ico:"images/icon_default.gif",link:"<%=path%>/admin/Custom_query.action"},
	{ level:2, name:"客户添加", ico:"images/icon_default.gif",link:"<%=path%>/admin/Custom_add.action"},

	{ level:1, name:"房屋管理"},
	{ level:2, name:"房屋列表", ico:"images/icon_default.gif",link:"<%=path%>/admin/Custom_query.action"},
	{ level:2, name:"房屋添加", ico:"images/icon_default.gif",link:"<%=path%>/admin/Custom_add.action"},
	
	{ level:1, name:"权限管理"},
	{ level:2, name:"管理组列表", ico:"images/icon_default.gif",link:"<%=path%>/admin/Managergroup_query.action"},
	{ level:2, name:"权限列表", ico:"images/icon_default.gif",link:"<%=path%>/admin/Action_query.action"},
